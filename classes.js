...
class ProgressiveManager extends Manager {
  ...
  hire(i){
    ...
    if((this.reports.length-1 === 0)){
       return this.title = 'Barely Manager';
    } 
    else if(this.reports.length-1 > 0 && this.reports.length-1 < 4){
       return this.title = 'Barely Manager';
    }
    else if(this.reports.length-1 >  3 && this.reports.length-1 < 11){
      return this.title = 'Mostly Manager';
    }
    else if(this.reports.length-1 > 10 && this.reports.length-1 < 51){
      return this.title = 'Manager';
    }
    else if(this.reports.length-1 > 50 && this.reports.length-1 < 101){
      return this.title = 'Manager Plus';
    }
    else if(this.reports.length-1 > 100){
